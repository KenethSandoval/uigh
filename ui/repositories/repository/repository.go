...
import (
	...
	"github.com/KenethSandoval/uigh/ui/repositories/repository/pane"
...
type (
	repositoryFilesLoadedMsg []*github.RepositoryContent
	repositoryFileLoadedMsg  *github.RepositoryContent
	repositoryErrorMsg       error
	status                   int
)
...
// Model represents a GitHub repository
type Model struct {
	Done bool
	Quit bool
